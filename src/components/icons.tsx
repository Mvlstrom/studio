...
export function UbicatitoIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
      ...
      <path fillRule="evenodd" clipRule="evenodd" d="M40 55C36.6863 55 34 52.3137 34 49C34 45.6863 36.6863 43 40 43C43.3137 43 46 45.6863 46 49C46 52.3137 43.3137 55 40 55ZM60 55C56.6863 55 54 52.3137 54 49C54 45.6863 56.6863 43 60 43C63.3137 43 66 45.6863 66 49C66 52.3137 63.3137 55 60 55Z" fill="#2E292A"/>
      ...
      <path d="M46 76C47.1046 75 48.8954 75 50 75C51.1046 75 52.8954 75 54 76" stroke="#2E292A" strokeWidth="2" strokeLinecap="round"/>
      <path d="M8 30C8 20 18 15 25 15" stroke="#2E292A" strokeWidth="2" strokeLinecap="round"/>
      <path d="M92 30C92 20 82 15 75 15" stroke="#2E292A" strokeWidth="2" strokeLinecap="round"/>
    </svg>
  )
}
